...
bar2 = Bar.create!(name: 'Lîlot Bar', address: '253 rue Nationale, 59800 Lille', user: user7, photo:"https://images.unsplash.com/photo-1575444758702-4a6b9222336e?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=1500&q=80")
bar3 = Bar.create!(name: 'La Nouvelle aventure ', address: '356 rue Léon Gambetta, 59000 Lille', user: user8, photo:"https://images.unsplash.com/photo-1470337458703-46ad1756a187?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1049&q=80")
bar4 = Bar.create!(name: 'Délirium café  ', address: '50 rue Masséna, 59800 Lille',  user: user9, photo:"https://images.unsplash.com/photo-1572116469696-31de0f17cc34?ixid=MnwxMjA3fDB8MHxzZWFyY2h8NHx8YmFyfGVufDB8MHwwfHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=700&q=60")
bar5 = Bar.create!(name: 'Le barbier qui fume ', address: '51 Rue d Esch-sur-Alzette, 59800 Lille, France', user: user10, photo: "https://images.unsplash.com/photo-1516997121675-4c2d1684aa3e?ixid=MnwxMjA3fDB8MHxzZWFyY2h8Nnx8YmFyfGVufDB8MHwwfHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=700&q=60")
bar6 = Bar.create!(name: 'Le Lyautey ', address: '12 Rue de Wazemmes, 59000 Lille, France', user: user11, photo:"https://images.unsplash.com/photo-1508253730651-e5ace80a7025?ixid=MnwxMjA3fDB8MHxzZWFyY2h8OHx8YmFyfGVufDB8MHwwfHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=700&q=60")
bar7 = Bar.create!(name: 'Kee Mao Bar ', address: '244 Rue Léon Gambetta, 59800 Lille, France', user: user12, photo:"https://images.unsplash.com/photo-1462539405390-d0bdb635c7d1?ixid=MnwxMjA3fDB8MHxzZWFyY2h8MTl8fGJhcnxlbnwwfDB8MHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=700&q=60")
bar8 = Bar.create!(name: 'Le Bistrot du Nouveau Siècle ', address: '11 Place Pierre Mendès France, 59800 Lille, France', user: user13, photo:"https://images.unsplash.com/photo-1591243315780-978fd00ff9db?ixid=MnwxMjA3fDB8MHxzZWFyY2h8MzF8fGJhcnxlbnwwfDB8MHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=700&q=60")
...
bar29 = Bar.create!(name: 'La Pépite', address: '12 Place Sébastopol, 59000 Lille', user: user34, photo:"https://images.unsplash.com/photo-1538333581680-29dd4752ddf2?ixid=MnwxMjA3fDB8MHxzZWFyY2h8NTB8fGJhcnxlbnwwfDB8MHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=700&q=60")
...
bar31 = Bar.create!(name: 'La Gastama ', address: '109 Rue Saint-André, 59000 Lille', user: user36, photo:"https://images.unsplash.com/photo-1538334591575-c5f86eb5793c?ixid=MnwxMjA3fDB8MHxzZWFyY2h8NjZ8fGJhcnxlbnwwfDB8MHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=700&q=60")
bar32 = Bar.create!(name: 'Le Barnetts ', address: '30 Rue Saint-Sébastien, 59800 Lille', user: user37, photo:"https://images.unsplash.com/photo-1513309914637-65c20a5962e1?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=1050&q=80")
...
bar35 = Bar.create!(name: 'La Biche et le renard', address: '14 Rue de Gand, 59800 Lille', user: user40, photo:"https://images.unsplash.com/photo-1555658636-6e4a36218be7?ixid=MnwxMjA3fDB8MHxzZWFyY2h8MTg4fHxiYXJ8ZW58MHwwfDB8fA%3D%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=700&q=60")
