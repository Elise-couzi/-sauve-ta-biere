...
bar1 = Bar.create!(name: 'Magnum Café ', address: '55 rue Masséna, 59800 Lille', user: user6)
bar2 = Bar.create!(name: 'Lîlot Bar', address: '253 rue Nationale, 59800 Lille', user: user7)
bar3 = Bar.create!(name: 'La Nouvelle aventure ', address: '356 rue Léon Gambetta, 59000 Lille', user: user8)
bar4 = Bar.create!(name: 'Délirium café  ', address: '50 rue Masséna, 59800 Lille',  user: user9)
bar5 = Bar.create!(name: 'Le barbier qui fume ', address: '51 Rue d Esch-sur-Alzette, 59800 Lille, France', user: user10)
bar6 = Bar.create!(name: 'Le Lyautey ', address: '12 Rue de Wazemmes, 59000 Lille, France', user: user11)
bar7 = Bar.create!(name: 'Kee Mao Bar ', address: '244 Rue Léon Gambetta, 59800 Lille, France', user: user12)
bar8 = Bar.create!(name: 'Le Bistrot du Nouveau Siècle ', address: '11 Place Pierre Mendès France, 59800 Lille, France', user: user13)
bar9 = Bar.create!(name: 'La Cloche ', address: '13 Place du Théâtre', user: user14)
bar10 = Bar.create!(name: 'Lestaminet ', address: '7 Rue Auber, 59800 Lille, France', user: user15)
bar11 = Bar.create!(name: 'La Trav Ieseg ', address: '2 Rue Solférino, 59000 Lille, France', user: user16)
bar12 = Bar.create!(name: 'Le Lobby ', address: '10 Rue Royale, 59800 Lille', user: user17)
bar13 = Bar.create!(name: 'Brasserie André  ', address: '71 rue de Béthune', user: user18)
bar14 = Bar.create!(name: 'Les 3 Brasseurs ', address: 'Place de la Gare, 59800 Lille, France', user: user19)
bar15 = Bar.create!(name: 'Au Paon d Or ', address: '2 place de Béthune, Lille, France', user: user20)
bar16 = Bar.create!(name: 'La Ducassse ', address: '95 rue Solférino , Lille, France', user: user21)
bar17 = Bar.create!(name: 'Lille Opéra Brasserie ', address: '32 rue Lepelletier , Lille, France', user: user22)
bar18 = Bar.create!(name: 'La Capsule Lille ', address: '25 Rue des trois Mollettes, 59800 Lille', user: user23)
bar19 = Bar.create!(name: 'Urban Bar ', address: '22 Rue du Court Debout, 59800 Lille, France', user: user24)
bar20 = Bar.create!(name: 'LEmbuscade ', address: '311 Rue de Lannoy, 59650 Villeneuve-d Ascq', user: user25)
bar21 = Bar.create!(name: 'Bar restaurant l Espérance ', address: '3 Place de la République, 59650 Villeneuve-d Ascq', user: user26)
bar22 = Bar.create!(name: 'Le Café de Paris ', address: '45 Avenue de Friedland, 75008 Paris', user: user27)
bar23 = Bar.create!(name: 'Brasserie Cézanne ', address: '45 Avenue Kléber, 75116 Paris', user: user28)
bar24 = Bar.create!(name: 'Aux Émotions ', address: '1 Rue Dante, 75005 Paris',  user: user29)
bar25 = Bar.create!(name: 'The Great Canadian PUB', address: '25 Quai des Grands Augustins, 75006 Paris', user: user30)
bar26 = Bar.create!(name: 'La Mousse Touch', address: '19 Boulevard Jean-Baptiste Lebas, 59000 Lille', user: user31)
bar27 = Bar.create!(name: 'La Craft Touch ', address: '9 Place Nouvelle Aventure, 59000 Lille', user: user32)
bar28 = Bar.create!(name: 'Bar des Familles', address: '21 Rue de Lappe, 75011 Paris', user: user33)
bar29 = Bar.create!(name: 'La Pépite', address: '12 Place Sébastopol, 59000 Lille', user: user34)
bar30 = Bar.create!(name: 'La Capsule ', address: '25 Rue des trois Mollettes, 59800 Lille', user: user35)
bar31 = Bar.create!(name: 'La Gastama ', address: '109 Rue Saint-André, 59000 Lille', user: user36)
bar32 = Bar.create!(name: 'Le Barnetts ', address: '30 Rue Saint-Sébastien, 59800 Lille', user: user37)
bar33 = Bar.create!(name: 'Le Taste n brews ', address: '348 Rue de Menin, 59700 Marcq-en-Barœul', user: user38)
bar34 = Bar.create!(name: 'Le Cirque', address: '139 Rue des Postes, 59000 Lille', user: user39)
bar35 = Bar.create!(name: 'La Biche et le renard', address: '14 Rue de Gand, 59800 Lille', user: user40)
bar36 = Bar.create!(name: 'Nul Bar Ailleurs', address: '18 Rue de Cotte, 75012 Paris, France', user: user41)
bar37 = Bar.create!(name: 'La liberté ', address: '1 Rue de la Gaité, 75014 Paris, France', user: user42)
bar38 = Bar.create!(name: 'LEntrePotes', address: '9 Rue Royale, 59800 Lille', user: user43)
bar39 = Bar.create!(name: 'À bout de souffle ', address: ' 17 Rue Campagne Première, 75014 Paris', user: user44)
bar40 = Bar.create!(name: 'L Archi Bar ', address: '13bis Rue Campagne Première, 75014 Paris, France', user: user45)
bar41 = Bar.create!(name: 'Le Falstaff ', address: '42 Rue du Montparnasse, 75014 Paris, France', user: user46)
bar42 = Bar.create!(name: 'Le Falguière', address: '129 Rue de Vaugirard, 75015 Paris, France', user: user50)
bar43 = Bar.create!(name: 'L Atelier de Vaugirard', address: '150 Rue de Vaugirard, 75015 Paris', user: user47)
bar44 = Bar.create!(name: 'L Italy Cafe ', address: '187 Rue de Vaugirard', user: user48)
bar45 = Bar.create!(name: 'Le Smoke ', address: '29 Rue Delambre, 75014 Paris',  user: user49)
...
beer9 = Beer.create!(name: 'Queue de Charrue Blonde', alcohol_degree: 6.6, category: 'blonde', description: "Créé en 2009 au vue du succès grandissant de la Queue de Charrue Triple, la version blonde des bières de la Brasserie Vanuxeem est peut être la petite dernière, il n'empêche qu'elle a déjà pas mal de bouteille ! La Queue de Charrue Blonde est une bière belge de fermentation haute qui présente dans le verre une robe de couleur blond clair à la transparence limpide mais troublée par la présence de levure dans la bouteille. Le tout est couvert d'une couche de mousse assez abondante mais peu persistante. Elle présente moins d'amertume que la Triple mais reste très moelleuse en bouche et présente un léger arôme fruité ainsi qu'un goût doux et généreux.Le nom 'Queue de Charrue' correspond à la traduction du nom flamand du village de Ploegsteert, situé à la frontière franco-belge, où est localisée la brasserie Vanuxeem !)")
